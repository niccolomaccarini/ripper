...
from wittgenstein3.utils import drop_chars
from wittgenstein3 import utils
from wittgenstein3.utils import rnd, weighted_avg_freqs
...
class Ruleset:
    ...
    def covers(self, df):
        ...
        if self.isuniversal():
            ...
            return covered
            #The following part belonged to the original code and was eliminated as part of debugging - Niccolò
